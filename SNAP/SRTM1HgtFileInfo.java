...
public class SRTM1HgtFileInfo {
    ...
    public void setFromData(final String fileName) throws IOException {
        ...
        System.out.println("setFromData " + fileName);
    ...
    public static void main(String args[]) throws IOException {
        ...
        try {
            ...
            SRTM1HgtFileInfo test = SRTM1HgtFileInfo.create(testfile);
            System.out.println(test.getFileName());
            System.out.println(test.getNorthing());
            System.out.println(test.getEasting());
        } catch (IOException e) {
